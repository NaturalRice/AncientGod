...
{
    public abstract class ModEnemyPet : ModProjectile
    {
        /// <summary>
        ...
        public virtual void PetSetDefaults()
        {
            ...
            Projectile.friendly = false;//非友好的宠物（Boss）
        ...
        /// Default is 12f
        /// </summary>
        public virtual float FlyingSpeed => 15f;//12f改为15f，更快一些
        ...
        public override void AI()//这里改为了非密封，去掉了sereal
        {
            PetBehaviour();
        }
