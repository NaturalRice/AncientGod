...
namespace AncientGod.Projectiles.Mounts.InfiniteFlight.ModernMecha
{
    public class ModernMechaBody : ModProjectile//此类用于实现AncientMecha的机械臂的行为。
    {
        ...
        public override void AI()
        {
            ...
            if (!modPlayer.ModernMecha)
                Projectile.timeLeft = 0;
            if (modPlayer.ModernMecha && Owner.mount.Active)//当然，还要再在这里强调一遍才能达到效果
        ...
        public override bool PreDrawExtras()//用于在绘制前执行额外的逻辑。其中，DrawChain 方法用于绘制链条效果
        {
            ...
            Texture2D teslaTex = (ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaTesla")).Value;
            Texture2D laserTex = (ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaLaser")).Value;
            Texture2D nukeTex = (ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaNuke")).Value;
            Texture2D plasmaTex = (ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaPlasma")).Value;
        ...
        public void DrawSingleArm(Texture2D handTex, Vector2 handPosition, float rotation, Vector2 offset, bool top, bool infernum = false)
        {
            ...
            Texture2D armTex = ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaArm").Value;//大臂
            Texture2D forearmTex = ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaForearm").Value;//小臂
        ...
        {
            Texture2D chainTex = ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaChain").Value;
        ...
        {
            Texture2D eyesTex = ModContent.Request<Texture2D>("AncientGod/Projectiles/Mounts/InfiniteFlight/ModernMecha/ModernMechaEyes").Value;
