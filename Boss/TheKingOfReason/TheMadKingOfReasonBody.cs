...
namespace AncientGod.Boss.TheKingOfReason
{

    [AutoloadBossHead]
    public class TheMadKingOfReasonBody : ModNPC
    {
        ...
        {
            return ModContent.NPCType<TheMadKingOfReasonMinion>();
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "AncientGod/Assets/Bestiary/TheMadKingOfReason_Preview",
        ...
        public override void SetDefaults()
        {
            ...
            // Custom boss bar
            NPC.BossBar = ModContent.GetInstance<TheMadKingOfReasonBossBar>();

            // The following code assigns a music track to the boss in a simple way.音乐暂不考虑
            /*if (!Main.dedServ)
            {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.BossBag(ModContent.ItemType<TheMadKingOfReasonBodyBag>()));

            // Trophies are spawned with 1/10 chance
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.Placeables.Furniture.TheMadKingOfReasonTrophy>(), 10));

            // ItemDropRule.MasterModeCommonDrop for the relic
            npcLoot.Add(ItemDropRule.MasterModeCommonDrop(ModContent.ItemType<Items.Placeables.Furniture.TheMadKingOfReasonRelic>()));
            ...
            notExpertRule.OnSuccess(ItemDropRule.Common(ModContent.ItemType<TheMadKingOfReasonMask>(), 7));
        ...
        public override void OnKill()
        {
            ...
            NPC.SetEventFlagCleared(ref DownedBossSystem.downTheMadKingOfReasonBoss, -1);
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                int backGoreType = Mod.Find<ModGore>("TheMadKingOfReasonBody_Back").Type;
                int frontGoreType = Mod.Find<ModGore>("TheMadKingOfReasonBody_Front").Type;
        ...
        private void SpawnMinions()
        {
            ...
            {
                NPC minionNPC = NPC.NewNPCDirect(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<TheMadKingOfReasonMinion>(), NPC.whoAmI);
                ...
                TheMadKingOfReasonMinion minion = (TheMadKingOfReasonMinion)minionNPC.ModNPC;
        ...
        private void CheckSecondStage()
        {
            ...
            for (int i = 0; i < Main.maxNPCs; i++)
            {
                ...
                if (otherNPC.active && otherNPC.type == MinionType() && otherNPC.ModNPC is TheMadKingOfReasonMinion minion)
                {
        ...
        private void DoSecondStage_SpawnEyes(Player player)
        {
            ...
            if (NPC.HasValidTarget && SecondStageTimer_SpawnEyes == 0 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                int type = ModContent.ProjectileType<Projectiles.Boss.TheMadKingOfReasonEye>();
