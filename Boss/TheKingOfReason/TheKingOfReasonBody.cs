...
namespace AncientGod.Boss.TheKingOfReason
{
	...
	/// </summary>
    public class TheKingOfReasonBody : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mods.AncientGod.Bestiary.TheKingOfReason")
            });
        }
        ...
        public override string GetChat()
        {
            ...
            chat.Add(Language.GetTextValue("恭喜你，你已经完成了击败月球领主的工作，回去接受人们的崇拜吧"));
            chat.Add(Language.GetTextValue("什么？你问我还有啥台词，现在就这一个，我还没想好。。。"));
            chat.Add(Language.GetTextValue("真就这一个。。。"));
