...
namespace AncientGod.Boss.MinionBoss
{
    ...
    public class MinionBossBody : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "AncientGod/Assets/Bestiary/MinionBoss_Preview",
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.Placeables.Furniture.MinionBossTrophy>(), 10));

            // ItemDropRule.MasterModeCommonDrop for the relic
            npcLoot.Add(ItemDropRule.MasterModeCommonDrop(ModContent.ItemType<Items.Placeables.Furniture.MinionBossRelic>()));
        ...
        private void DoSecondStage_SpawnEyes(Player player)
        {
            ...
            if (NPC.HasValidTarget && SecondStageTimer_SpawnEyes == 0 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                int type = ModContent.ProjectileType<Projectiles.Boss.MinionBossEye>();
