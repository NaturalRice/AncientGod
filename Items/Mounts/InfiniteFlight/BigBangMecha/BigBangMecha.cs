...
{
    internal class BigBangMecha : ModMount
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MountData.buff = ModContent.BuffType<BigBangMechaBuff>();//坐骑提供的Buff类型
            ...
            {
                Asset<Texture2D> texture = ModContent.Request<Texture2D>("AncientGod/Items/Mounts/InfiniteFlight/BigBangMecha/BigBangMecha_Back");
        ...
        public override bool Draw(List<DrawData> playerDrawData, int drawType, Player drawPlayer, ref Texture2D texture, ref Texture2D glowTexture, ref Vector2 drawPosition, ref Rectangle frame, ref Color drawColor, ref Color glowColor, ref float rotation, ref SpriteEffects spriteEffects, ref Vector2 drawOrigin, ref float drawScale, float shadow)
        {
            ...
            Texture2D mountTex = ModContent.Request<Texture2D>("AncientGod/Items/Mounts/InfiniteFlight/BigBangMecha/BigBangMecha_Back_Glow").Value;
