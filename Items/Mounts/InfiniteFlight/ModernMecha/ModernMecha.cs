...
namespace AncientGod.Items.Mounts.InfiniteFlight.ModernMecha
{
    public class ModernMecha : ModMount
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MountData.buff = ModContent.BuffType<ModernMechaBuff>();//坐骑提供的Buff类型
            ...
            {
                Asset<Texture2D> texture = ModContent.Request<Texture2D>("AncientGod/Items/Mounts/InfiniteFlight/ModernMecha/ModernMecha_Back");
        ...
        public override bool Draw(List<DrawData> playerDrawData, int drawType, Player drawPlayer, ref Texture2D texture, ref Texture2D glowTexture, ref Vector2 drawPosition, ref Rectangle frame, ref Color drawColor, ref Color glowColor, ref float rotation, ref SpriteEffects spriteEffects, ref Vector2 drawOrigin, ref float drawScale, float shadow)
        {
            ...
            Texture2D mountTex = ModContent.Request<Texture2D>("AncientGod/Items/Mounts/InfiniteFlight/ModernMecha/ModernMecha_Back_Glow").Value;
