...
namespace AncientGod.Items.Placeables
{
	public class WasteMetal : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.WasteMetal>());
			Item.width = 16;
			Item.height = 16;
		}
        ...
        //Recipe craft_terrariaBlade = Recipe.Create(ItemID.TerraBlade);
        //craft_terrariaBlade.AddIngredient<WasteMetal>(10);
        //craft_terrariaBlade.Register();
        //CreateRecipe(10)
