...
{
    public class BaseSkeletonWallItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createWall = ModContent.WallType<Tiles.SpaceBase.Walls.BaseSkeletonWall>();
        }
        ...
        public override void AddRecipes()//测试用,正常玩时注解掉
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<BaseSkeleton>(), 1);//加入材料
