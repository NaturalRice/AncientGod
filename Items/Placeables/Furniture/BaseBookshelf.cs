...
{
    public class BaseBookshelf : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.Furniture.BaseBookshelf>();
            Item.width = 12;
            Item.height = 12;
            Item.rare = 0;
        }
        ...
        public override void AddRecipes()//测试用,正常玩时注解掉
        {
            ...
            recipe.AddIngredient(ItemID.Book, 10);//加入材料（1火把）
            recipe.AddIngredient(ModContent.ItemType<BaseEnclosure>(), 20);//加入材料
