...
{
    public class TheMadKingOfReasonSummonItem : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return !NPC.AnyNPCs(ModContent.NPCType<TheMadKingOfReasonBody>());
        }
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                int type = ModContent.NPCType<TheMadKingOfReasonBody>();
