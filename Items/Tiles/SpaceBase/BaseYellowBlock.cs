...
{
    public class BaseYellowBlock : ModTile
    {
        ...
        {
            //地表附近掉种子，其余地方不掉
            int[] LootCandidate = { ModContent.ItemType<Items.Placeables.SpaceBase.BaseYellowBlock>(), ItemID.Wood };
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("AncientGod/Items/Tiles/SpaceBase/BaseYellowBlock").Value;
            Texture2D glowTexture = ModContent.Request<Texture2D>("AncientGod/Items/Tiles/SpaceBase/BaseYellowBlock_Glow").Value;
            ...
            int height = tile.TileFrameY % (AnimationFrameHeight + 1) == 36 ? 18 : 16;//这一行的AnimationFrameHeight默认是0，使用%求余数时相当于除以0了
