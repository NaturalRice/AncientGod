...
{
    public class BaseGlass : ModTile
    {
        ...
        {
            //地表附近掉种子，其余地方不掉
            int[] LootCandidate = { ModContent.ItemType<Items.Placeables.SpaceBase.BaseGlass>(), ItemID.Wood };
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("AncientGod/Items/Tiles/SpaceBase/BaseGlass").Value;
            Texture2D glowTexture = ModContent.Request<Texture2D>("AncientGod/Items/Tiles/SpaceBase/BaseGlass_Glow").Value;
