...
namespace AncientGod.Items.Tiles//这里照搬了：tModLoader/ExampleMod/Content/Tiles/ExampleAnimatedGlowmaskTile.cs
{
    public class AncientGodAnimatedGlowmaskTile : ModTile
    {
        // 如果你想了解更多关于tiles的信息，请点击这个链接。
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("AncientGod/Items/Tiles/AncientGodAnimatedGlowmaskTile").Value;
            Texture2D glowTexture = ModContent.Request<Texture2D>("AncientGod/Items/Tiles/AncientGodAnimatedGlowmaskTile_Glow").Value;
    ...
    internal class AncientGodAnimatedGlowmaskTileItem : ModItem
    {
        public override void SetDefaults()
        {
            Item.CloneDefaults(ItemID.VoidMonolith);
            Item.createTile = ModContent.TileType<AncientGodAnimatedGlowmaskTile>();
        }

        /*public override void AddRecipes()
        {
            CreateRecipe()
                .AddIngredient<AncientGodItem>()
                .AddTile<Furniture.AncientGodWorkbench>()
                .Register();
        }*/
