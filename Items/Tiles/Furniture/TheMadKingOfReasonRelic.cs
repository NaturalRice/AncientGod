...
{
    public class TheMadKingOfReasonRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "AncientGod/Items/Tiles/Furniture/TheMadKingOfReasonRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "AncientGod/Items/Tiles/Furniture/RelicPedestal";
