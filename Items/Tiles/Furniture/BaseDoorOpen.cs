...
{
    public class BaseDoorOpen : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileID.Sets.CloseDoorID[Type] = ModContent.TileType<BaseDoorClosed>();
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Placeables.Furniture.BaseDoor>();
        }
    }
}
