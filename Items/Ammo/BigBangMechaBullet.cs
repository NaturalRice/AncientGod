...
{
    internal class BigBangMechaBullet : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.Ammo.BigBangMechaBullet>(); // The projectile that weapons fire when using this item as ammunition.
