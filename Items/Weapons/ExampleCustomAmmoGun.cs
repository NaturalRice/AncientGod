...
namespace AncientGod.Items.Weapons
{
    ...
    public class ExampleCustomAmmoGun : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.useAmmo = ModContent.ItemType<BigBangMechaBulletSide>(); // Restrict the type of ammo the weapon can use, so that the weapon cannot use other ammos
        }
