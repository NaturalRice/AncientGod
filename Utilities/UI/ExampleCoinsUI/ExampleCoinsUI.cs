...
namespace AncientGod.Utilities.UI.ExampleCoinsUI
{
    ...
    internal class ExampleCoinsUIState : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            Asset<Texture2D> BackgroundTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/BackgroundTexture");
            Asset<Texture2D> BorderTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/BorderTexture");
            CoinCounterPanel = new ExampleDraggableUIPanel(null, BackgroundTexture);
            ...
            SetRectangle(CoinCounterPanel, left: 400f, top: 100f, width: 300f, height: 300f);//CoinCounterPanel 的左上角位于屏幕的 (400, 100) 像素位置，宽度为 170 像素，高度为 70 像素。
            ...
            Asset<Texture2D> buttonZeroTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseZero");
            ExampleUIHoverImageButton playButton = new ExampleUIHoverImageButton(buttonZeroTexture, "万能机甲");
            ...
            Asset<Texture2D> buttonOneTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseOne");
            ExampleUIHoverImageButton closeButton = new ExampleUIHoverImageButton(buttonOneTexture, Language.GetTextValue("万能蠕虫")); // Localized text for "Close"
            ...
            Asset<Texture2D> buttonTwoTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseTwo");
            ExampleUIHoverImageButton twoButton = new ExampleUIHoverImageButton(buttonTwoTexture, Language.GetTextValue("万能眼球")); // Localized text for "Close"
            ...
            Asset<Texture2D> buttonThreeTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseThree");
            ExampleUIHoverImageButton threeButton = new ExampleUIHoverImageButton(buttonThreeTexture, Language.GetTextValue("万能飞虫")); // Localized text for "Close"
            ...
            Asset<Texture2D> buttonFourTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseFour");
            ExampleUIHoverImageButton fourButton = new ExampleUIHoverImageButton(buttonFourTexture, Language.GetTextValue("万能??")); // Localized text for "Close"
            ...
            Asset<Texture2D> buttonFiveTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseFive");
            ExampleUIHoverImageButton fiveButton = new ExampleUIHoverImageButton(buttonFiveTexture, Language.GetTextValue("万能??")); // Localized text for "Close"
            ...
            Asset<Texture2D> buttonSixTexture = ModContent.Request<Texture2D>("AncientGod/Utilities/UI/ExampleCoinsUI/ChooseSix");
            ExampleUIHoverImageButton sixButton = new ExampleUIHoverImageButton(buttonSixTexture, Language.GetTextValue("万能??")); // Localized text for "Close"
