...
namespace AncientGod.Utilities.UI
{
    internal class ExampleCoinsUIState : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            Asset<Texture2D> buttonPlayTexture = ModContent.Request<Texture2D>("AncientGod/icon");
            ...
            Asset<Texture2D> buttonDeleteTexture = ModContent.Request<Texture2D>("AncientGod/icon");
